...
<#assign m1 = "i" />
<#assign m2 = "k3jl" />
<#assign seoTitle = "快3玩法规则-帮助中心-搜狗彩票" />
<#assign seoKeywords = "快3玩法规则" />
<#assign seoDescription = "快3游戏是指以三个号码组合为一注进行单式投注，每个投注号码为1-6共六个自然数中的任意一个,一组三个号码的组合称为一注。每注金额人民币2元。购买者可对其选定的投注号码进行多倍投注,投注倍数范围为2-99倍。单张彩票的投注金额最高不得超过20000元。" />
...
<div class="help_main">
	...
	<div class="hcont cf" id="help_center">
		...
		<div class="hright">
			<!--切换标签-->
			<div class="tab cf">
				<a href="/help/i-k3jl-rule.html" class="cur">玩法规则</a>
				<a href="/help/i-k3jl-play.html">玩法介绍</a>
...
<p>
	第六条　快3游戏是指以三个号码组合为一注进行单式投注，每个投注号码为1-6共六个自然数中的任意一个　,　一组三个号码的组合称为一注。每注金额人民币2元。购买者可对其选定的投注号码进行多倍投注　,　投注倍数范围为2-99倍。单张彩票的投注金额最高不得超过　20000　元。
</p>
<p>
...
<p>
	第十六条　快3游戏设置奖池。奖池资金由当期计提奖金与实际中出奖金的差额组成。当期实际中出奖金小于计提奖金时，余额进入奖池；当期实际中出奖金超过计提奖金时，差额由奖池资金补足。当奖池资金总额不足时，由调节基金补足，调节基金不足时，用彩票机构业务费垫支。在出现业务费垫支的情况下，当调节基金有资金滚入时优先偿还垫支的业务费。当奖池资金超过　200　万元时，超出部分转入调节基金。
</p>
<p class="top">
	<b>第四章　开　奖　　</b>
</p>
