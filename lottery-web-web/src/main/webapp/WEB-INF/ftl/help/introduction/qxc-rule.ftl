...
<#assign m1 = "i" />
<#assign m2 = "qxc" />
<#assign seoTitle = "七星彩玩法规则-帮助中心-搜狗彩票" />
<#assign seoKeywords = "七星彩玩法规则" />
<#assign seoDescription = "7星彩是指从0000000-9999999中选择任意7位自然数进行的投注，一组7位数的排列称为一注，每注金额人民币2元。购买者可进行多倍投注，投注倍数范围为2-99倍。单张彩票最大投注数量不得超过10000注。"/>
...
<div class="help_main">
	...
	<div class="hcont cf" id="help_center">
		...
		<div class="hright">
			<!--切换标签-->
			<div class="tab cf">
				<a href="/help/i-qxc-rule.html" class="cur">玩法规则</a>
