...
<#assign m1 = "i" />
<#assign m2 = "ssq" />
<#assign seoTitle = "双色球玩法规则-帮助中心-搜狗彩票" />
<#assign seoKeywords = "双色球玩法规则" />
<#assign seoDescription = "双色球彩票投注区分为红色球号码区和蓝色球号码区。每注投注号码由6个红色球号码和1个蓝色球号码组成。红色球号码从1--33中选择；蓝色球号码从1--16中选择，每注2元。采取全国统一奖池计奖。每周销售三期，期号以开奖日界定，按日历年度编排。"/>
...
<div class="help_main">
	...
	<div class="hcont cf" id="help_center">
		...
		<div class="hright">
			<!--切换标签-->
			<div class="tab cf">
				<a href="/help/i-ssq-rule.html" class="cur">玩法规则</a>
				<a href="/help/i-ssq-play.html">玩法介绍</a>
				<a href="/help/i-ssq-award.html">奖项规则</a>
			</div>
			<div class="cont">
				<!--内容.start-->
<p>
...
<p>
	<img src="${cdnBaseUrl}img/help/introduction/ssq01.jpg" /> 
</p>
<p>
