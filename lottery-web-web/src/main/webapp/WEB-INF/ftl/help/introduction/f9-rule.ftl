...
<#assign m1 = "i" />
<#assign m2 = "f9" />
<#assign seoTitle = "任选九玩法规则-帮助中心-搜狗彩票" />
<#assign seoDescription = "任选九玩法规则" />
<#assign seoKeywords = "胜负任选9场是以中国足球彩票胜负玩法所选择的足球比赛场次为竞猜对象，购买“胜负任选9场”时，由购买者从中国足球彩票胜负玩法选择的所有竞猜场次中的任意9场竞猜场次中每场比赛在全场90分钟（含伤情补时）比赛的胜平负的结果进行投注" />
...
<div class="help_main">
	...
	<div class="hcont cf" id="help_center">
		...
		<div class="hright">
			<!--切换标签-->
			<div class="tab cf">
				<a href="/help/i-f9-rule.html" class="cur">玩法规则</a>
