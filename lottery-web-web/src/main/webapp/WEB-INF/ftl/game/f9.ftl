...
<div class="cp-infos wrapper">
    ...
    <div class="info2 sfc-bg">
        <a href="${domainUrl}f9/" class="ilogo f9-logo ct">${game.gameCn}</a>
        <div class="imenu">
            <a href="${domainUrl}f9/" class="cur">选号投注<span class="ct"></span></a>
        </div>
        <div class="ilink">
...
<div class="wrapper">
    <div class="sfc-type">
        <ul>
            <li><a href="${domainUrl}f14/">胜负彩</a></li>
            <li><a href="${domainUrl}f9/" class="cur">任选九</a></li>
        </ul>
    </div>
</div>
<div class="wrapper">
            ...
            <div class="jjc-nav sfc-main">
                <div pbflag="wc_0_投注区" id="zc_rx9">
                    <p class="tips">
                        ...
                        <b>玩法提示：</b>竞猜14场球队中任意9场的比赛结果，每场比赛至少选择一个比赛结果，单注最高奖金<span>500万</span>元
                    </p>
                ...
                <div pbflag="wc_0_确认选号" class="ball-item-list" id="zc_rx9_ball_list"<#if .now lt nowPeriod.startTime> style="display:none"</#if>>
