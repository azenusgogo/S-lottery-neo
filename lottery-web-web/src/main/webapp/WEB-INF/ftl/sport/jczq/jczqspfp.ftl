        ...
        <table class="jcarea">
            ...
            <tbody class="jc_row" data='{"date":"${m.matchNoCn}","nick":"${m.displayHomeName!} VS ${m.displayAwayName!}","matchid":"${m.matchNo!}","league":"${m.leagueName!}","time":"${m.matchTime?string("yyyyMMdd")}"}'>
                <tr>
                    ...
                    <td class="dosel"><a model='{"type":"spf","index":"1","code":"11103","sp":"${m.sps["11103"]}","matchid":"${m.matchNo!}"}' href="#">${m.sps["11103"]}</a></td>
                    <td class="dosel"><a model='{"type":"spf","index":"2","code":"11101","sp":"${m.sps["11101"]}","matchid":"${m.matchNo!}"}' href="#" class="m">${m.sps["11101"]}</a></td>
                    <td class="dosel"><a model='{"type":"spf","index":"3","code":"11100","sp":"${m.sps["11100"]}","matchid":"${m.matchNo!}"}' href="#">${m.sps["11100"]}</a></td>
                    <td><label><input type="checkbox" class="dm" disabled="" matchid="${m.matchNo!}"></label></td>
                    <td class="spv">
                        <span>${m.tOddsWin!"--"}</span>
                        <span class="m">${m.tOddsDraw!"--"}</span>
                        <span>${m.tOddsLose!"--"}</span>
                    </td>
                    <td class="fx">
                        <a href="">析</a>
                        <a href="">亚</a>
